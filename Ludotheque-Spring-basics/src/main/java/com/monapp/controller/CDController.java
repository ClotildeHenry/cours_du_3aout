...
import com.monapp.metier.validator.CDValidator;
...
public class CDController {
	...
	public String processAddNewArtistForm(@ModelAttribute("cd") CD cd, BindingResult bindingResult
			) {
		
		new CDValidator().validate(cd, bindingResult);
