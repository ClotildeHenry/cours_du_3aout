...
public class ArtisteController {
	...
	public String processAddNewArtistForm(@ModelAttribute("artiste") Artiste artiste, BindingResult bindingResult) {
		
		new ArtisteValidator().validate(artiste, bindingResult);
